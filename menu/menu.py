...
def pdpa_text() -> str:
    output = 'By using this Telegram bot, @smux_bot, you hereby agree that Singapore Management University (SMU) may collect, use and disclose your personal data that you provide to this bot for the purpose of sending you updates for activites and future events by SMU Xploration Crew (SMUX).\n\n'
